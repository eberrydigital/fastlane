...
module Fastlane
  module Actions
    ...
    class GetApplePayProcessingCertificateAction < Action
      def self.run(params)
        login(params)
      ...
      def self.create_certificate(params)
        ...
        csr, pkey = Spaceship.certificate.create_apple_pay_certificate_processing_signing_request
      ...
      def self.example_code
        [
          'get_apple_pay_processing_certificate(
